...
async function lancement() {
	...
	await page.type('#username',"n.hameau25");//process.env.USER
	await page.type('#password',"Chouchou17!");//process.env.PASSWORD
	console.log("3");
...
function lireFichier(){
    var fs = require('fs');
    fs.readFile("devoir.txt", 'utf8', function(err, data) {
    	const content = data;
        let top = [];
...
client.login("ODgxOTUwMTE2NTY1NjMwOTg2.YS0SDQ.BQCO00cC-OPHKMf_bXDmL5BaMJ4");//process.env.TOKEN
